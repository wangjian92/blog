...
::: tip
看一下 V2Ray 的工作原理，以下是单个 V2Ray 进程的内部结构示意图。多个 V2Ray 之间互相独立，互不影响。
...
或者去[v2ray神一样的工具们](https://www.v2ray.com/awesome/tools.html)选择一个图形客户端安装

### v2ray客户端配置

如果下载使用图形客户端可以进入对应的配置页面配置服务器 ip 地址、端口、uuid等信息即可，我这里以github的官网客户端配置文件配置为例
